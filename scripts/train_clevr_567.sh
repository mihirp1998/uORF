...
python train_without_gan.py --dataroot $DATAROOT --n_scenes 4 --n_img_each_scene 4  \
    ...
    --fixed_locality --display_port $PORT --display_ncols 4 --print_freq 2 --display_freq 2 --display_grad \
    --load_size 64 --n_samp 12 --input_size 64 --supervision_size 64 --coarse_epoch 600 --z_dim 8 --num_slots 1 --no_mask --display_env primitive1\
